...
public class AutoShooterModePos1 extends Command {
  ...
  public void initialize() {
    if (Constants.kPrintOperatorShooterModePodium){
      System.out.println("==========================");
      System.out.println("Command Operator: AutoShooterModePos1");
    }
    ...
    m_shooterSubsystem.setShooterSpeed(Constants.kShooterAutoPos1Speed);
    ...
    switch(m_stateMachine) {     
      case 1:  // Front intake in position
        ...
        if (m_frontIntakeSubsystem.getFrontIntakeInPosition(Constants.kFrontIntakeClearPos)) {
          m_shooterSubsystem.setShooterArmPosition(Constants.kShooterArmAutoPos1Pos);
      ...
      if (Constants.kPrintOperatorShooterModePodium){System.out.println("Operator Command ShooterModePodium: Case 2 Started");}
        if (m_shooterSubsystem.getShooterArmInPosition(Constants.kShooterArmAutoPos1Pos)) {
