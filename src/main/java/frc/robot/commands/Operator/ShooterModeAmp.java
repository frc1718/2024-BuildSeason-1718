...
public class ShooterModeAmp extends Command {
  ...
  public void initialize() {
    if (Constants.kPrintOperatorShooterModeAmp){
      System.out.println("==========================");
  ...
  public void execute() {
    ...
    switch(m_stateMachine) {     
      ...
      if (Constants.kPrintOperatorShooterModeAmp){System.out.println("Operator Command ShooterModeAmp: Case 1 Started");}
        if (m_frontIntakeSubsystem.getFrontIntakeInPosition(Constants.kFrontIntakeClearPos)) {
          ...
          if (Constants.kPrintOperatorShooterModeAmp){System.out.println("Operator Command ShooterModeAmp: Case 1 Complete");}
          m_stateMachine = m_stateMachine + 1;
        }        
        break;
      case 2:  // Arm in position
        if (Constants.kPrintOperatorShooterModeAmp){System.out.println("Operator Command ShooterModeAmp: Case 2 Started");}
        if (m_shooterSubsystem.getShooterArmInPosition(Constants.kShooterArmAmpPos)) {
          if (Constants.kPrintOperatorShooterModeAmp){System.out.println("Operator Command ShooterModeAmp: Case 2 Complete");}
          m_stateMachine = m_stateMachine + 1;
        }
        break;
      case 3:  // Shooter up to speed
        if (Constants.kPrintOperatorShooterModeAmp){System.out.println("Operator Command ShooterModeAmp: Case 3 Started");}       
        if (m_shooterSubsystem.getShooterUpToSpeed(Constants.kShooterAmpSpeed)) {
          if (Constants.kPrintOperatorShooterModeAmp){System.out.println("Operator Command ShooterModeAmp: Case 3 Complete");}
          m_isFinished = true;
        }
        break;
    }
