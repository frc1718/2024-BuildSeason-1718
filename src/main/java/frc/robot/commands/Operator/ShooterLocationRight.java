 ...
 */
public class ShooterLocationRight extends Command {
   ...
   * Required.
   */
  public ShooterLocationRight(ClimberSubsystem climberSubsystem) {
  ...
  public void initialize() {
    m_climberSubsystem.setClimbLocation("RightClimb");
    m_isFinished = true;
  }
