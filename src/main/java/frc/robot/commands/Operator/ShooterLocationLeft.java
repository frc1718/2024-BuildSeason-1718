 ...
 */
public class ShooterLocationLeft extends Command {
   ...
   * Required.
   */
  public ShooterLocationLeft(ClimberSubsystem climberSubsystem) {
  ...
  public void initialize() {
    m_climberSubsystem.setClimbLocation("LeftClimb");
    m_isFinished = true;
  }
